...
<template>
    <div class="todayDataBox rel">
        ...
        <div class="echartsBox">
            <echartsHunNingTuToday v-if="idx==0" id="hunNingTuToday" :height="height+10" />
            <echartsTaJiToday v-if="idx==1" id="taJiToday" :height="height" :arr="[20, 7, 10, 3]" />
            <div style="padding-top:10px">
                <echartsYangChenToday v-if="idx==5" id="yangChenToday" :height="height" />
            </div>
        </div>
...
import echartsHunNingTuToday from './echarts_hunNingTu_today'
import echartsTaJiToday from './echarts_taJiToday'
import echartsYangChenToday from './echarts_yangChenToday'
export default {
    name: 'todayData',
    components: {
        echartsHunNingTuToday, echartsTaJiToday, echartsYangChenToday
    },
    props: {
        height: {
            type: Number,
